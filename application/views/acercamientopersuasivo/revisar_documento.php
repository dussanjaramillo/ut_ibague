        ...
        <tr>
            <td align="center">
                <table><tr>
                        ...
                        <td><button id="enviar" class='btn btn-success' onclick="f_enviar(<?php echo $cod_aprobacion; ?>)"><?php if (ID_USUARIO == ID_SECRETARIO): echo "Pre-Aprobar"; else:"Aprobar";endif;?></button></td>
